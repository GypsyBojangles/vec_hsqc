...
legmat = np.loadtxt( os.path.join( curdir, 'training_eg_02_legmat' ), dtype=str ) 
cs_array = np.loadtxt( os.path.join( curdir, 'training_eg_02_Fsp' ) ) 
y = np.loadtxt( os.path.join( curdir, 'skl_log_pred_y' ) )
